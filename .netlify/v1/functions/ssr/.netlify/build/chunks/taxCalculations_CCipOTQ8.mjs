const federalCapitalGainsRates = {
  ...
  head_of_household: [
    { min: 0, max: 63e3, rate: 0 },
    { min: 63e3, max: 551350, rate: 0.15 },
    { min: 551350, max: Infinity, rate: 0.2 }
  ]
};
const stateCapitalGainsRates = {
  "AL": 0.05,
  "AK": 0,
  "AZ": 0.025,
  "AR": 0.059,
  ...
  "VA": 0.0575,
  "WA": 0.07,
  // New capital gains tax on high earners
  "WV": 0.065,
  "WI": 0.0765,
  "WY": 0,
  "DC": 0.1075
...
const NIITThreshold = {
  single: 2e5,
  married_joint: 25e4,
  married_separate: 125e3,
  head_of_household: 2e5
};
function calculateTaxSavings(input) {
  const originalBasis = input.purchasePrice + input.improvements + input.closingCosts;
  const adjustedBasis = originalBasis;
...
export { calculateTaxSavings as c, formatCurrency as f, stateNames as s };
